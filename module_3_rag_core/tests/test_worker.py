...
from rag_core.worker import vectorize_document_task, warmup_models


@pytest.mark.asyncio
@patch("rag_core.worker.Path")
@patch("rag_core.worker.get_store")
@patch("rag_core.worker.chunk_document")
@patch("rag_core.worker.enrich_document")
...
@pytest.mark.asyncio
@patch("rag_core.worker.warmup_tokenizer")
@patch("rag_core.worker.get_store")
